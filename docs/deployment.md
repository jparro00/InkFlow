...
_No pending changes — dev is in sync with prod as of 2026-04-24 (migration 00021 + agent-parse/parse-booking edge fns + all-day/multi-day bookings + load-time perf batch)._
